"""
╔══════════════════════════════════════════════════════════════╗
║          BHAVESH PATIL AI STUDIO — Premium Chat Interface        ║
║     Data Scientist | ML Engineer | Generative AI Developer   ║
╚══════════════════════════════════════════════════════════════╝

Architecture:
  • bhavesh_ai_studio.py      ← main entry point (this file)
...
# ─────────────────────────────────────────────
st.set_page_config(
    page_title="BHAVESH PATIL AI Studio",
    page_icon="✦",
    layout="wide",
...
def conversation_to_markdown() -> str:
    lines = [
        "# BHAVESH PATIL AI Studio — Conversation Export",
    ...
    with st.sidebar:
        ...
        st.markdown(
            ...
            <div class="profile-block">
                ...
                <div class="profile-name">BHAVESH PATIL</div>
...
def render_hero() -> None:
    st.markdown(
        ...
        <div class="hero-container">
            ...
            <h1 class="hero-title">BHAVESH PATIL AI Studio</h1>
            <p class="hero-sub">
    ...
    st.markdown(
        ...
        <div class="footer">
            <span class="footer-left">
                <span class="footer-accent">BHAVESH PATIL AI Studio</span>
